...
function bindSession(slug, sessionId, tackId) {
    ...
    switch (command) {
        ...
        case "repo": {
            ...
            if (sub === "alias") {
                ...
                console.log(`rebuilt repos.yaml: ${r.repoCount} repos (${r.urlsMatched} forge URLs across routes, ${r.localsAdded} new locals)`);
            }
            else if (sub === "rm") {
                if (!subArgs[0])
                    usage();
...
// would not cover it.
function reportInvalidSessions() {
